...
@freezed
abstract class TimeSheetFilterState with _$TimeSheetFilterState {
...
class TimeSheetFilterNotifier extends _$TimeSheetFilterNotifier {
  ...
  void updateExportStartDate(DateTime? date) {
    state = state.copyWith(startDateExport: date);
  }

  void updateExportEndDate(DateTime? date) {
    state = state.copyWith(endDateExport: date);
  }

  void updateExportSelectedDesigner(EmployeeList? selectedDesigner) {
    state = state.copyWith(selectedDesignerExport: selectedDesigner);
  }

  void updateExportItemNo(String? itemNo) {
    state = state.copyWith(selectedItemNoExport: itemNo);
  }

  void updateExportWorkOrderNo(String? workOrderNo) {
