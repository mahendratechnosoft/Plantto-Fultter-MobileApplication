...
class ApiEndPoints {
  ...
  static const String baseURL = "https://api.planetto.xpertbizsolutions.com/";
  static const String login = "${baseURL}auth/login";
  static const String logOut = "${baseURL}user/logout";
  static const String fetchTimeSheetsForApproval =
      "${baseURL}timesheet/getListNotApprovedWorkStatus";
  static const String approveTimeSheetApi =
      "${baseURL}timesheet/approvedWorkStatus";
  ...
  static const String fetchProcessForFilterExport =
      "${baseURL}work/getWorkOrderByItemNoWithCancel";
  ...
  static const String filterTimeSheet =
      "${baseURL}timesheet/getAllTimeSheets/0/1000";
